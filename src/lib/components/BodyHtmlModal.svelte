    ...
    <div class="modal body-modal">
      ...
      <div class="body-modal-grid">
        <div class="body-pane">
          ...
          <textarea class="body-textarea" bind:value={htmlValue} on:input={handleTextInput}></textarea>
        </div>
        <div class="body-pane">
...
<style>
  ...
  .modal-tools { display: flex; gap: 0.5rem; }
  .btn-tool { padding: 0.4rem 0.6rem; border: 1px solid #d1d5db; border-radius: 6px; background: white; cursor: pointer; }
  .body-modal-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-top: 1rem; }
  .body-pane { display: flex; flex-direction: column; gap: 0.5rem; }
  .pane-title { font-size: 0.85rem; font-weight: 600; color: #6b7280; }
  .body-textarea { min-height: 320px; border: 1px solid #e5e7eb; border-radius: 6px; padding: 0.75rem; font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: 0.85rem; }
  .body-contenteditable { min-height: 320px; border: 1px solid #e5e7eb; border-radius: 6px; padding: 0.75rem; background: #fafafa; overflow: auto; }
  .modal-actions { display: flex; justify-content: flex-end; margin-top: 1rem; gap: 0.5rem; }
