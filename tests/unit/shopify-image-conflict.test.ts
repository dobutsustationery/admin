...
function detectConflicts(
  ...
  options: {
    ...
    shopifyToDriveMap: Record<string, string>;
  },
) {
...
describe("Shopify Import Logic", () => {
  const existingImage =
    "https://cdn.getshifter.co/d299a556d96edb77676c949380ed2e36fe885e0a/uploads/2021/07/4542804081374.jpg";
  const shopifyImage =
    "https://cdn.shopify.com/s/files/1/0582/2559/0461/products/4542804081374.jpg?v=1626759000";
