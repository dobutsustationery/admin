...
test.skip("Debug Gemini Models for Image Editing", async ({ page }) => {
  // 0. Setup
  ...
  const strategies = [
    {
      ...
      prompt:
        "Remove the background from this image. Return ONLY the raw Base64 encoded string of the resulting PNG image.",
      mimeType: "text/plain",
    },
    {
